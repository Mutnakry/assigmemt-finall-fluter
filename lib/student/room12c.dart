...
class Room12c extends StatefulWidget {
  const Room12c({Key? key}) : super(key: key);

  @override
  State<Room12c> createState() => _Room12cState();
}

class _Room12cState extends State<Room12c> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('ថ្នាក់ទី 12C'), // Class 12C in Khmer
      ),
